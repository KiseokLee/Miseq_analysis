...
otu_rel <- otu_table(phy.clean.10) # remove asv that has less than 10 reads total.
class(otu_rel)
...
phy.clean.10 # 5467 ASV

psmelt_family <- psmelt(phy.clean.10)
...
phy.clean.10
mat_meta <- as.matrix(sample_data(phy.clean.10))
class(mat_meta)
...
## Is there a gradual change in relative log abundance?
1. remove the spike in reads
2. 
